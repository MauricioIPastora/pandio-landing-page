        ...
        <div className="flex flex-col items-center justify-center h-screen relative z-10">
            ...
            <div className="rounded-2xl bg-foreground/50 backdrop-blur-sm transition-all duration-300 p-2.5 group hover:pl-8 hover:py-2 inline-flex">
                <div id="gooey-btn" className="relative flex items-center group" style={{ filter: "url(#gooey-filter)" }}>
                    <button className="absolute right-0 px-2.5 py-2 rounded-full bg-gradient-to-b from-[#FF8FC4] via-[#FF6FAE] to-[#E55A9A] text-foreground text-xs transition-all duration-300 hover:bg-[#FF6FAE]/90 cursor-pointer h-8 flex items-center justify-center -translate-x-28 group-hover:-translate-x-36 z-0 shadow-[0_1px_4px_0_rgba(255,111,174,0.15)]">
                    <svg className="w-3 h-3" fill="#FF6FAE" stroke="currentColor" viewBox="0 0 24 24">
